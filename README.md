...
**6. 운영으로 증명**
Caddy 기반 Let's Encrypt 자동 HTTPS, 일일 pg_dump + 주간 디스크 스냅샷 백업 자동화,
그리고 알림·배포 훅을 운영 환경에서 직접 E2E 검증했습니다 — 임계값 위반을 유도해 Discord
장애/복구 알림 실수신을 확인하고, 훅의 401/409 가드와 커밋 SHA 추적까지 실트래픽으로 검증한
**실제로 돌아가는 서비스**입니다.
